...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    after_files = { "/home/alpha/.local/share/nvim/site/pack/packer/opt/copilot-cmp/after/plugin/copilot_cmp.lua" },
    load_after = {
      ["copilot.lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/alpha/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
  ...
  ["copilot.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/alpha/.local/share/nvim/site/pack/packer/opt/copilot.lua",
  ...
  ["nvim-bqf"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/alpha/.local/share/nvim/site/pack/packer/opt/nvim-bqf",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/alpha/.local/share/nvim/site/pack/packer/start/onedark.vim",
  ...
  vim = {
    loaded = true,
    path = "/home/alpha/.local/share/nvim/site/pack/packer/start/vim",
